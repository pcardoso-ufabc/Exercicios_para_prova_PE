...
3⃣ Somar os elementos de uma lista (recursivo)

Implemente uma função recursiva em C que receba uma lista simplesmente encadeada contendo números inteiros e retorne a soma de todos os 
...
int soma_lista(No *lista){
    ...
    if (lista == NULL)
        return 0;
    return lista->valor + soma_lista(lista->prox);
}
